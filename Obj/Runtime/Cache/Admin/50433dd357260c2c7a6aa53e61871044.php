        ...
        <div class="layui-body">
            <div class="layui-card">
                <div class="layui-card-header layui-bg-gray">
                    <?php echo ($menu_nav); ?>
                    <?php if(auth($member,'Admin/Groups/adds')): ?><button id="layui-add" class="layui-btn layui-btn-normal layui-btn-sm" style="float:right;margin:5px;" data='<?php echo U("adds");?>'> 添加角色 </button><?php endif; ?>
                </div>
                        ...
                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                    <div class="layui-btn-group">
                                        <?php if(auth($member,'Admin/Groups/edits')): ?><button class="layui-btn layui-btn-sm layui-edit" data='<?php echo U("edits",array("id"=>$vo[id]),"");?>'>修改权限</button><?php endif; ?>
                                        <?php if(auth($member,'Admin/Groups/dels')): ?><button class="layui-btn layui-btn-danger layui-btn-sm layui-del" data='<?php echo U("dels",array("id"=>$vo[id]),"");?>'>删除角色</button><?php endif; ?>
                                    </div>
                                </td>
